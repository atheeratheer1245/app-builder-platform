...
describe("Android native Google sign-in", () => {
  it("uses Credential Manager without a WebView or browser redirect for Google sign-in", () => {
    ...
    const googleFlow = activitySource.slice(activitySource.indexOf("private fun nativeGoogleSignIn"), activitySource.indexOf("private fun nativeEmailAuth"));
    expect(googleFlow).not.toContain("ACTION_VIEW");
  });
