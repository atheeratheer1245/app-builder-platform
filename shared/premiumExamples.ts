...
export const premiumExampleCatalog: PremiumExample[] = [
  {
    ...
    components: [
      ...
      { pageKey: "cart", componentType: "Form", labelAr: "", labelEn: "", properties: { contextPageKey: "cart", submitLabelAr: "تأكيد الطلب", submitLabelEn: "Confirm order" } },
  ...
  },
  {
    ...
    components: [
      ...
      { pageKey: "quiz", componentType: "Form", labelAr: "", labelEn: "", properties: { contextPageKey: "quiz", submitLabelAr: "إرسال الإجابات", submitLabelEn: "Submit answers" } },
  ...
  },
  {
    ...
    components: [
      ...
      { pageKey: "booking", componentType: "Form", labelAr: "", labelEn: "", properties: { contextPageKey: "booking", submitLabelAr: "إرسال طلب الحجز", submitLabelEn: "Submit booking request" } },
