...
export function getDefaultComponentProperties(type: BuilderComponentType, category: TemplateCategory): ComponentProperties {
  ...
  if (type === "GameScene") return { gameMode: "platformer", preset: "platformer", sceneNameAr: "", sceneNameEn: "", backgroundAssetId: null, durationSeconds: 90, progressionMode: "linear", showHud: true, musicEnabled: true, soundEffectsEnabled: true, persistenceEnabled: false, checkpointEnabled: true, layer: 1 };
  if (type === "Player") return { gameMode: "platformer", spriteAssetId: null, imageAssetId: null, imageAssetUrl: "", videoAssetId: null, videoAssetUrl: "", audioAssetId: null, audioAssetUrl: "", speed: 6, jumpForce: 12, lives: 3, startX: 8, startY: 64, respawnEnabled: true, layer: 30 };
